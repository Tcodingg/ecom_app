			...
			<div className=''>
				<div key={id} id={id}>
					...
					<div className='adjust_qty'>
						...
						<button className='increment_btn qty_btn' onClick={increment}>
							+
						</button>
						<button className='decrement_btn qty_btn' onClick={decrement}>
							-
						</button>
						<p
...
>>>>>>> d2304895c51be8ed6300b04412e5aa27f90e886d
}
